...
import './WellTile.css'; // Optional CSS for styling

ChartJS.register(LineElement, CategoryScale, LinearScale, PointElement);

const WellTile = ({ title, tankLevel, actualFlowRate, targetFlow, pressureDelta, strokesPerMin, hasFault }) => {
